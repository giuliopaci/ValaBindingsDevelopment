...
namespace Xml {
	...
	public class Node {
		...
		[CCode (cname = "xmlNodeBufGetContent", instance_pos = -1)]
		public string get_content_buffer(Buffer buffer);
 ...
 */
	/* xmlbuffer - the XMLBuffer implementation */

	[CCode (cname = "xmlBufferAllocationScheme", cprefix = "XML_BUFFER_ALLOC_", cheader_filename = "libxml/tree.h")]
	public enum BufferAllocationScheme {
		DOUBLEIT,
		EXACT,
		IMMUTABLE,
		IO;
		[CCode (cname = "xmlGetBufferAllocationScheme")]
		public static BufferAllocationScheme get();
		[CCode (cname = "xmlSetBufferAllocationScheme")]
		public static void set(BufferAllocationScheme scheme);
	}
	...
	public class Buffer {
		...
		public Buffer ();
		[CCode (cname = "xmlBufferCreateStatic")]
		public Buffer.static ([CCode (array_length = false)] void* buffer, size_t len);
		[CCode (cname = "xmlBufferCreateSize")]
		public Buffer.size (size_t size);

		[CCode (cname = "xmlBufferContent")]
		public unowned string get_content();
		[CCode (cname = "xmlBufferLength")]
		public int get_length();
		[CCode (cname = "xmlBufferResize")]
		public int resize(uint size);
		[CCode (cname = "xmlBufferGrow")]
		public int grow(uint len);
		[CCode (cname = "xmlBufferShrink")]
		public int shrink(uint len);
		[CCode (cname = "xmlBufferWriteCHAR")]
		public int write_char(string str);
		[CCode (cname = "xmlBufferAdd")]
		public int add(char* str, int len);
		[CCode (cname = "xmlBufferCCat")]
		public int c_cat(string str);
		[CCode (cname = "xmlBufferWriteQuotedString")]
		public int write_quoted_string(string str);
		...
		public int dump (GLib.FileStream f);
		#endif
		[CCode (cname = "xmlBufferSetAllocationScheme")]
		public void set_allocation_scheme(BufferAllocationScheme scheme);
		[CCode (cname = "xmlBufferEmpty")]
		public void empty();
		[CCode (cname = "xmlBufferAddHead")]
		public void add_head(string str, int len);
		[CCode (cname = "xmlAttrSerializeTxtContent")]
		public void attr_serialize_txt_content(Doc doc, Attr attr, string str);
		[CCode (cname = "xmlNodeDump")]
		public int node_dump(Doc doc, Node cur, int level, int format);
	}
...
// int	xmlSchemaSAXUnplug		(xmlSchemaSAXPlugPtr plug);
	...
	public class SchemaParserCtxt {
		...
		public SchemaParserCtxt (string cur);

		[CCode (cname = "xmlSchemaNewMemParserCtxt")]
		public SchemaParserCtxt.from_mem ([CCode (array_length = false)] char[] data, int size);

		[CCode (cname = "xmlSchemaNewDocParserCtxt")]
		public SchemaParserCtxt.from_doc (Doc doc);

		[CCode (cname = "xmlSchemaIsValid")]
		public int is_valid ();

		[CCode (cname = "xmlSchemaParse")]
		public Schema parse ();

		[CCode (cname = "xmlSchemaGetParserErrors")]
		public int get_errors (Xml.SchemaValidityErrorFunc err_func, Xml.SchemaValidityWarningFunc warn_func, void ** ctx);
		[CCode (cname = "xmlSchemaSetParserErrors")]
		public int set_errors (Xml.SchemaValidityErrorFunc err_func, Xml.SchemaValidityWarningFunc warn_func, void * ctx);
		[CCode (cname = "xmlSchemaSetParserStructuredErrors")]
		public void set_structured_errors	(Xml.xmlStructuredErrorFunc serror, void * ctx);
	}
	...
	public class SchemaValidCtxt {
		...
		public SchemaValidCtxt (Schema schema);
...
//		public int	validate_stream		(ParserInput xmlParserInputBufferPtr input, CharEncoding enc, SAXHandler sax, void * user_data);
		...
		[CCode (cname = "xmlSchemaSetValidStructuredErrors")]
		public void	set_structured_errors	(Xml.xmlStructuredErrorFunc serror, void * ctx);
		[CCode (cname = "xmlSchemaSetValidErrors")]
		public void	set_errors		(Xml.SchemaValidityErrorFunc err, Xml.SchemaValidityWarningFunc warn, void * ctx);
		[CCode (cname = "xmlSchemaValidCtxtGetOptions")]
		public int	get_options	();
		[CCode (cname = "xmlSchemaValidateFile")]
		public int	validate_file		(string filename, int options);
		[CCode (cname = "xmlSchemaValidateDoc")]
		public int	validate_doc		(Doc doc);
		[CCode (cname = "xmlSchemaGetValidErrors")]
		public int	get_errors		(Xml.SchemaValidityErrorFunc err, Xml.SchemaValidityWarningFunc warn, void ** ctx);
		[CCode (cname = "xmlSchemaSetValidOptions")]
		public int	set_options	(int options);
		[CCode (cname = "xmlSchemaValidCtxtGetParserCtxt")]
		public ParserCtxt	xmlSchemaValidCtxtGetParserCtxt	();
	}
}
