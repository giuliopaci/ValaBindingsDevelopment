...
<!--   <member name="CURLKHSTAT_FINE_ADD_TO_FILE"/> -->
<!--   <member name="CURLKHSTAT_FINE"/> -->
<!--   <member name="CURLKHSTAT_REJECT"/> -->
<!--   <member name="CURLKHSTAT_DEFER"/> -->
<!--   <member name="CURLKHSTAT_LAST"/> -->
<!-- 		</enum> -->


<!-- <enum name="curl_khmatch"> -->
<!--   <member name="CURLKHMATCH_OK"/> -->
<!--   <member name="CURLKHMATCH_MISMATCH"/> -->
<!--   <member name="CURLKHMATCH_MISSING"/> -->
<!--   <member name="CURLKHMATCH_LAST"/> -->
<!-- 		</enum> -->
